          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/80 mb-8">
                Razendsnelle websites met Next.js. Geen gedoe, geen maandelijkse kosten. Gewoon
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg">
                  ...
                  <span className="text-white text-sm">
                    Al 15+ Rotterdamse ondernemers gingen je voor
                  </span>
                </div>
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg">
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 mb-8">Kies het pakket dat bij jou past</p>
            <Link
              href="/pakketten/"
      ...
      <section className="py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 mb-8">Alles wat je wilt weten</p>
            <Link
              href="/faq/"
              className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 font-medium"
            >
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="font-semibold text-gray-900 mb-2">
                Moet ik zelf technische dingen doen?
              </h3>
              <p className="text-gray-600">
                Nee! Jij regelt je bedrijf, ik regel je website. Je krijgt een simpele uitleg hoe
                je teksten kunt aanpassen (bij het Pro pakket), maar technisch hoef je niets te
                doen.
              </p>
            </div>
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <p className="text-gray-600">
                €0,-. Geen hostingkosten, geen onderhoudskosten. Je betaalt één keer en klaar.
                Alleen je domeinnaam (€15 per jaar) is voor eigen rekening.
              </p>
            </div>
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="font-semibold text-gray-900 mb-2">
                Hoe lang duurt het voordat mijn site live is?
              </h3>
              <p className="text-gray-600">
                Binnen 1-2 weken na akkoord staat je nieuwe site online.
              </p>
            </div>
          </div>
        </div>
