...
import { Check, X, Phone, Zap, Clock, Shield, TrendingUp, Star, Award } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import type { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'Pakketten - WebBoostPartner',
  description:
    'Transparante prijzen voor professionele websites. Kies tussen WebBoost Start (€1.500) of WebBoost Pro (€3.500). Geen verborgen kosten.',
  alternates: {
    canonical: 'https://www.webboostpartner.nl/pakketten/',
  },
};
    ...
    <div className="pt-24">
      ...
      <section className="py-16 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">Onze Pakketten</h1>
          <p className="text-xl text-white/80 max-w-2xl mx-auto">
            Transparante prijzen zonder verborgen kosten. Kies het pakket dat past bij jouw
            onderneming.
          </p>
        </div>
      </section>
