        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-xl text-gray-700 leading-relaxed mb-12">
              ...
              kapotte plugin en het uitleggen aan een klant waarom hun website weer traag was, 
              begon er iets te knagen.
            </p>

            <p className="text-2xl font-semibold text-blue-900 mb-16">
            ...
            <p className="text-gray-700 leading-relaxed mb-16">
              Niet omdat ik niet meer wilde bouwen. Integendeel. Ik wilde alleen bouwen wat echt werkt.
            </p>

            {/* Wat ik nu doe */}
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              Wat ik nu doe, doe ik anders
            </h2>
            <p className="text-gray-700 leading-relaxed mb-6">
              ...
              die stukgaan. Geen updates die mislukken. Geen trage laadtijden die bezoekers wegjagen.
            </p>
            <p className="text-gray-700 leading-relaxed mb-6">
            ...
            <p className="text-gray-700 leading-relaxed mb-16">
              ...
              werkde. Of het echt beter was. Het was niet alleen beter — het was zoals het altijd 
              had moeten zijn.
            </p>
            ...
            <div className="space-y-8 mb-16">
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <p className="text-gray-700">
                  We bespreken wat je nodig hebt. Geen verplichtingen, gewoon een gesprek. 
                  Daarna krijg je een heldere offerte.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <p className="text-gray-700">
                  ...
                  wilt: een eenvoudig CMS zodat je zelf teksten kunt wijzigen zonder technische kennis.
                </p>
              </div>
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              Ik praat geen technisch jargon. Ik leg uit wat je moet weten, in gewoon Nederlands. 
              Ik ben direct — als iets niet kan, zeg ik dat. Als er een betere manier is, vertel ik die.
            </p>
            <p className="text-gray-700 leading-relaxed mb-16">
      ...
      <section className="py-24 bg-gradient-to-br from-blue-900 to-slate-900">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/80 mb-8">
            Geen verplichtingen. Gewoon een gesprek om te zien wat je nodig hebt 
